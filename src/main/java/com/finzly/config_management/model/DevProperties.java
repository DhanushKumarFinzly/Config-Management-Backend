...
public class DevProperties implements BaseProperties {
    ...
    public DevProperties(String id, String fieldGroup, String application, String profile, String label, String propKey, String value, String propertyType, Boolean secret, String lastUpdatedBy, LocalDateTime lastUpdatedDate) {
        this.id = id;
        this.fieldGroup = fieldGroup;
        this.application = application;
        this.profile = profile;
